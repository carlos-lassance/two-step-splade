...
./pisa/build/bin/compress_inverted_index --encoding block_simdbp --collection pisa-canonical/$dataset/full/full --output pisa-index/$dataset/full/block_simdbp.idx
./pisa/build/bin/compress_inverted_index --encoding block_simdbp --collection pisa-canonical/$dataset/pruned/pruned --output pisa-index/$dataset/pruned/block_simdbp.idx
...
./pisa/build/bin/create_wand_data --collection pisa-canonical/$dataset/full/full --block-size 40 --scorer quantized --output pisa-index/$dataset/full/quantized-40.bmw
./pisa/build/bin/create_wand_data --collection pisa-canonical/$dataset/full/full --block-size 40 --scorer saturated_tf --bm25-k1 100 --output pisa-index/$dataset/full/saturated-40.bmw

./pisa/build/bin/create_wand_data --collection pisa-canonical/$dataset/pruned/pruned --block-size 40 --scorer quantized --output pisa-index/$dataset/pruned/quantized-40.bmw
./pisa/build/bin/create_wand_data --collection pisa-canonical/$dataset/pruned/pruned --block-size 40 --scorer saturated_tf --bm25-k1 100 --output pisa-index/$dataset/pruned/saturated-40.bmw


# 3. We'll build the document map, and the lexicon map, though we don't need the term lexicon (you will see why soon)
./pisa/build/bin/lexicon build pisa-canonical/$dataset/full/full.documents pisa-canonical/$dataset/full/full.docmap
./pisa/build/bin/lexicon build pisa-canonical/$dataset/full/full.terms pisa-canonical/$dataset/full/full.termmap

./pisa/build/bin/lexicon build pisa-canonical/$dataset/pruned/pruned.documents pisa-canonical/$dataset/pruned/pruned.docmap
./pisa/build/bin/lexicon build pisa-canonical/$dataset/pruned/pruned.terms pisa-canonical/$dataset/pruned/pruned.termmap
